  ...
  def update
    respond_to do |format|
      if @report.update(report_params)
        format.html { redirect_to report_url(@report), notice: t('controllers.common.notice_update', name: Book.model_name.human) }
...
def authorize_user
  ...
  flash[:alert] = t('controllers.common.alert_auth', name: Report.model_name.human)
  redirect_to @report
end
